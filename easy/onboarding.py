...
while 1:
    ...
    closest_enemy = sorted(enemies, key=lambda enemy: enemy[1])[0]

    # Write an action using print
    # To debug: print >> sys.stderr, "Debug messages..."

    print "{}".format(closest_enemy[0]) # The name of the most threatening enemy (HotDroid is just one example)
